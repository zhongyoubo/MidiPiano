...
import com.sky.musiclearn.utils.FocusFrameView;
...
public class MainLayout extends FrameLayout{
    ...
    private void setOnListener() {
        personalModel.setOnFocusChangeListener(new OnFocusChangeListener() {
            @Override
            public void onFocusChange(View v, boolean hasFocus) {
                if(hasFocus){
                    //personalModel.animate().scaleX(1.2f).scaleY(1.2f).start();
                    //Toast.makeText(context,"studyModel focused",Toast.LENGTH_LONG).show();
                }
            }
        });
        personalModel.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //Toast.makeText(context,"studyModel Selected",Toast.LENGTH_SHORT).show();
            }
        });

        studyModel.setOnFocusChangeListener(new OnFocusChangeListener() {
            @Override
            public void onFocusChange(View v, boolean hasFocus) {
                if(hasFocus){
                    //Toast.makeText(context,"teachModel focused",Toast.LENGTH_LONG).show();
                }
            }
        });
        studyModel.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
               //startStudyModelActivity();
                //Toast.makeText(context,"teachModel Selected",Toast.LENGTH_SHORT).show();
            }
        });
    }
